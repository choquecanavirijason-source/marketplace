...
CREATE TABLE "roles" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "roles_codename_unique" UNIQUE("codename")
);
--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"type" varchar(50) DEFAULT 'buyer' NOT NULL,
...
CREATE TABLE "documents" (
	...
	"document_type" varchar(50) DEFAULT 'NATIONAL_ID' NOT NULL,
...
CREATE TABLE "verifications" (
	...
	"provider" varchar(50) DEFAULT 'LOCAL_MOCK' NOT NULL,
...
ALTER TABLE "documents" ADD CONSTRAINT "documents_verification_id_verifications_id_fk" FOREIGN KEY ("verification_id") REFERENCES "public"."verifications"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
