# Módulo 13 — Búsqueda IA y Recomendador

> Referencia: marketplace.md §15

## Propósito

Ranking híbrido semántico, embeddings, recomendaciones personalizadas y asistente de decisión con fallback.
