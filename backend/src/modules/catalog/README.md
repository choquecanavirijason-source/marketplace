# Módulo 2 — Catálogo, Categorías y Productos

> Referencia: marketplace.md §4

## Propósito

Árbol de categorías, atributos, productos maestro, variantes, media, precios, stock y workflow de publicación (BORRADOR → PUBLICADO). Indexación a OpenSearch.
