# Módulo 5 — Pagos y Conciliación

> Referencia: marketplace.md §7

## Propósito

Orquestación de pago multi-proveedor (Stripe, MercadoPago), escrow, webhooks firmados, conciliación y reembolsos.
