...
const LINK_COLUMNS = [
  ...
  },
  {
    title: "Categorías",
    links: [
      { label: "Herramientas Eléctricas", href: "/categorias/herramientas-electricas" },
  ...
  },
  {
    title: "Mi Cuenta",
    links: [
      { label: "Mi Perfil", href: "/cuenta/dashboard" },
      { label: "Historial de Pedidos", href: "/cuenta/dashboard" },
